...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.superhuman/superhuman.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde superhuman dashboard --no-open en tu escritorio.",
    },
    insecure: {
