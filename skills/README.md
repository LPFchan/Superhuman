...
- Preserve this repo's existing Superhuman/OpenClaw skill packages in the root `skills/` tree.
- Do not move the root `skills/` tree under `scaffold/`.
- `skills/upstream-intake/SKILL.md` stays in the tree because this repo keeps `upstream-intake/` active.
