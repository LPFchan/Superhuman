...
1. Capture work from chat, the UI, or a direct operator prompt.
2. Route the work into the right project surface: truth, status, plans, research, decisions, execution, or upstream review.
