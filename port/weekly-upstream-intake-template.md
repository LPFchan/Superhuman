...
This file lives in `port/` until the internal docs tree moves to `architecture/`.
Once that rename happens, move this template with the rest of the internal planning docs.
