...
| `port/`           | current internal planning root             | keep during Phase 1; later rename target is `architecture/`                                              |
| `architecture/`   | future internal docs root                  | target name, not active yet                                                                              |
