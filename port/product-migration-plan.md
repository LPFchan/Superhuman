...
- `port/` acts as internal architecture and migration documentation rather than end-user docs
...
- Use `port/weekly-upstream-intake-template.md` to record each weekly intake decision until the internal docs tree moves to `architecture/`.
...
Record each review in `port/weekly-upstream-intake-template.md` until the internal docs tree moves to `architecture/`.
