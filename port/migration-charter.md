...
| Internal planning root during Phase 1 | `port/`                                 | temporary until Phase 6 rename |
...
The working inventory for those classifications lives in `port/current-surface-inventory.md`.
...
- `port/migration-charter.md`
- `port/current-surface-inventory.md`
- `port/plugin-contract-map.md`
- `port/plugin-compatibility-matrix.md`
- `port/naming-glossary.md`
