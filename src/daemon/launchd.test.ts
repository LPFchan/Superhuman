...
function expectLaunchctlEnableBootstrapOrder(env: Record<string, string | undefined>) {
  ...
  const label = "ai.superhuman.gateway";
...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.superhuman.gateway\n";
  ...
  it.each([
    {
      ...
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.superhuman.gateway.plist",
    },
    {
      ...
      expected: "/Users/test/Library/LaunchAgents/ai.superhuman.jbphoenix.plist",
    },
    {
    ...
    },
    {
      ...
      expected: "/Users/test/Library/LaunchAgents/ai.superhuman.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
