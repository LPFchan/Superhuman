...
const METHOD_SCOPE_GROUPS: Record<OperatorScope, readonly string[]> = {
  ...
  [READ_SCOPE]: [
    ...
    "automation.loop.get",
    "automation.notifications.list",
    "automation.artifacts.list",
    "automation.subscriptions.list",
    "automation.remoteSchedules.list",
  ...
  [WRITE_SCOPE]: [
    ...
    "automation.subscriptions.ingest",
    "automation.loop.set",
    "automation.remoteSchedules.run",
  ],
  [ADMIN_SCOPE]: [
    "channels.logout",
    "agents.create",
    ...
    "cron.remove",
    "cron.run",
    "automation.subscriptions.upsert",
    "automation.remoteSchedules.upsert",
    "sessions.patch",
    "sessions.reset",
    "sessions.delete",
    "sessions.compact",
