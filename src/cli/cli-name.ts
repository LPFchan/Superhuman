...
export const DEFAULT_CLI_NAME = "superhuman";

const KNOWN_CLI_NAMES = new Set([DEFAULT_CLI_NAME, "openclaw", "superhuman"]);
const CLI_PREFIX_RE = /^(?:((?:pnpm|npm|bunx|npx)\s+))?(openclaw|superhuman)\b/;
