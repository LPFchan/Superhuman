...
This directory is the canonical home for Superhuman's recurring upstream OpenClaw intake workflow.
...
If a file outside this directory references the old root-level intake template, treat this directory as the source of truth.
The root-level template is kept only as a compatibility entry point.
