...
Detailed implementation playbooks now live in [README.md](README.md). The main architecture document keeps the phase ordering and dependency logic, while the `architecture/` docs hold agent-ready execution detail.
