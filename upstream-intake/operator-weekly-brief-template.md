...
Use this format for the lighter operator-facing weekly intake summary.
...
Use whatever wording fits the week.
...
It is fine to have no security note, two watch items, or no operator decision if that is the real state of the week.
...
The phrasing should vary naturally from week to week.
Do not label bullets with rigid stock phrases unless they genuinely read well in that week's brief.
...
- Decisions to carry forward next week:
