...
- Install via CLI: `superhuman plugins install @openclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `superhuman plugins install ./path/to/local/zalo-plugin`
   - From npm (if published): `superhuman plugins install @openclaw/zalo`
...
This page reflects current Superhuman behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `superhuman pairing list zalo`
  - `superhuman pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Superhuman.
...
- Example: `superhuman message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `superhuman channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `superhuman logs --follow`
