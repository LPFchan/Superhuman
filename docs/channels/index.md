---
summary: "Messaging platforms Superhuman can connect to"
read_when:
  - You want to choose a chat channel for Superhuman
...
Superhuman can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- Channels can run simultaneously; configure multiple and Superhuman will route per chat.
