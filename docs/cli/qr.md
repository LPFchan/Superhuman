---
summary: "CLI reference for `superhuman qr` (generate iOS pairing QR + setup code)"
read_when:
...
```bash
superhuman qr
superhuman qr --setup-code-only
superhuman qr --json
superhuman qr --remote
superhuman qr --url wss://gateway.example/ws
```
