---
summary: "Overview of Superhuman onboarding options and flows"
read_when:
...
Superhuman has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `superhuman onboard`                   | Launch the app            |
...
CLI command docs: [`superhuman onboard`](/cli/onboard)

## macOS app onboarding

Open the Superhuman app. The first-run wizard walks you through the same steps
