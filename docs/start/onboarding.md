---
summary: "First-run setup flow for Superhuman (macOS app)"
read_when:
...
- By default, Superhuman is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give Superhuman">
...
<Step title="CLI">
  ...
  The app can install the global `superhuman` CLI via npm/pnpm so terminal
